...
(function() {
  this.jKanban = function() {
        ...
        self.drakeBoard = self
          .dragula([self.container], {
            moves: function(el, source, handle, sibling) {
              ...
              return (
                  handle.classList.contains("card-header") ||
                  handle.classList.contains("card-title")
              );
            },
    ...
    this.enableAllBoards = function() {
        var allB = document.querySelectorAll(".card");
    ...
    this.addBoards = function(boards, isInit) {
      ...
      for (var boardkey in boards) {
        ...
        if (board.class !== "" && board.class !== undefined)
          ...
          headerBoard.classList.add("card-header");
        ...
        //content board
        var contentBoard = document.createElement("div");
          contentBoard.classList.add("card-body");
        ...
        //add drag to array for dragula
          ...
          for (var itemkey in board.item) {
              if (itemkey == 0) {
                  ...
                  var contentBoardBody = document.createElement("ul");
                  boardNode.appendChild(contentBoardBody);
              }
          //create item
